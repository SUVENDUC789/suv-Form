...
if($_SERVER['REQUEST_METHOD']=='POST')
{
    ...
    $sql="INSERT INTO `question` (`sl`, `questiontitle`, `op1`, `op2`, `op3`, `op4`, `orans`, `mark`, `type`) VALUES (NULL, '$tit', '$set1', '$set2', '$set3', '$set4', '$mainAns', '1', 'mcq')";
...
<body>
    ...
    <div class="container my-5">
        ...
        <form action="mcq_set.php" method="post">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="LastOption" id="LastOption" placeholder="Enter Last Option.">
            </div>
            <div class="mb-3">
                <label for="Original_answer" class="form-label"><b>Original answer</b></label>
                <input type="text" class="form-control" name="Original_answer" id="Original_answer" placeholder="Enter Original answer Option.">
            </div>
